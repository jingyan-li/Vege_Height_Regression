...
class SatelliteSet(VisionDataset):
    ...
    def __init__(self, dfile_path, feature_windows, windowsize=16, multiple=False, num_feature=8):
        super().__init__(None)
        self.wsize = windowsize
        self.file_path = dfile_path
        self.sh_x, self.sh_y = windowsize, windowsize  # size of each image
        self.feat_window = feature_windows # No. of windows in total
    ...
    def __getitem__(self, index):
        if self.multiple:
            ...
            file = f"D:\jingyli\ImageInterpretation_Regression\data\data_c8_p{num_pic+1}_new.hdf5"
