...
def get_pretrained_feature_from_h5(h5_file, num_feature=8,multiple=False):
    if multiple:
...
class SatelliteSet(VisionDataset):
    def __init__(self, dfile_path, windowsize=224, multiple=False, num_feature=16):
        ...
        self.sh_x, self.sh_y = 16, 16  # size of each image
        self.feat_window = 235984
    ...
    def __getitem__(self, index):
        if self.multiple:
            ...
            file = f"D:\\II_LAB2_DATA\\new\\data_c8_p{num_pic+1}_new.hdf5"
            ...
            # print("GTshape", self.y_data.shape)
...
#     h5_path = r"D:\II_LAB2_DATA\c16_v2"
#     dset = SatelliteSet(h5_path, num_feature=16, multiple=True)
